...
(function(i, ha, t, p) {
	var m = function(h) {
		...
		function P(a, b) {
			...
			b = a.aoData.length;
			var d = i.extend(true, {}, m.models.oRow);
			d._aData = c;
			a.aoData.push(d);
			var e;
			d = 0;
			for ( var f = a.aoColumns.length; d < f; d++) {
				...
				typeof c.fnRender === "function" && c.bUseRendered
						&& c.mDataProp !== null && S(a, b, d, ba(a, b, d));
		...
		function ja(a) {
			...
			for (j = a.aoColumns.length; e < j; e++) {
				...
				var y = k.sClass !== null, u = k.bVisible, v, z;
				if (f || l || y || !u) {
					b = 0;
					for (c = a.aoData.length; b < c; b++) {
						...
						if (f && k.sType != "string") {
							...
							if (z !== "") {
								...
								if (k.sType === null)
									k.sType = z;
								else if (k.sType != z && k.sType != "html")
									k.sType = "string"
							}
						}
		...
		function E(a, b, c, d) {
			...
			if ((c = e.fnGetData(a.aoData[b]._aData, d)) === p) {
				if (a.iDrawError != a.iDraw && e.sDefaultContent === null) {
					M(a, 0, "Requested unknown parameter '" + e.mDataProp
		...
		function H(a) {
			...
			if (i.inArray(false, c) !== -1)
				...
				L(a, "aoHeaderCallback", "header", [
						i(a.nTHead).children("tr")[0], la(a), a._iDisplayStart,
						a.fnDisplayEnd(), a.aiDisplay ]);
				L(a, "aoFooterCallback", "footer", [
						i(a.nTFoot).children("tr")[0], la(a), a._iDisplayStart,
						a.fnDisplayEnd(), a.aiDisplay ]);
		...
		function da(a, b) {
			b = i(b).children("tr");
			var c, d, e, f, g, j, l, k, y = function(z, Y, B) {
				for (; z[Y][B];)
					B++;
				return B
			};
			...
			c.bind("keyup.DT", function() {
				for ( var e = a.aanFeatures.f, f = 0, g = e.length; f < g; f++)
					e[f] != i(this).parents("div.dataTables_filter")[0]
							&& i(e[f]._DT_Input).val(this.value);
		...
		function wa(a, b) {
			if (!a.oFeatures.bServerSide) {
				...
				for ( var c = 0, d = b.length; c < d; c++)
					a.asDataSearch[c] = za(a, ka(a, b[c], "filter"))
			}
		}
		function za(a, b) {
			var c = "";
		...
		function Wa(a) {
			var b = a.nScrollHead.getElementsByTagName("div")[0], c = b
					.getElementsByTagName("table")[0], d = a.nTable.parentNode, e, f, g, j, l, k, y, u, v = [], z = a.nTFoot !== null ? a.nScrollFoot
					.getElementsByTagName("div")[0]
					: null, Y = a.nTFoot !== null ? z
			...
			if (i(a.nTable).outerWidth() < e) {
				...
				if (a.nTFoot !== null)
					z.parentNode.style.width = s("100%")
			}
			if (a.oScroll.sY === "")
				if (B)
			...
			if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
				...
				if (a.nTable.offsetHeight < d.offsetHeight)
					d.style.height = s(i(a.nTable).height() + B)
			}
		...
		function X(a, b) {
			var c, d, e, f, g, j, l = [], k = [], y = m.ext.oSort, u = a.aoData, v = a.aoColumns, z = a.oLanguage.oAria;
			if (!a.oFeatures.bServerSide
				...
				for (c = 0; c < l.length; c++) {
					...
					if (m.ext.afnSortData[f]) {
						...
						if (g.length === u.length) {
							...
							M(a, 0, "Returned data sort array (col " + d
									+ ") is the wrong length")
					}
				}
				c = 0;
								...
								.setAttribute(
										...
										v[c].sTitle
												+ ((v[c].asSorting[l[0][2] + 1] ? v[c].asSorting[l[0][2] + 1]
														: v[c].asSorting[0]) == "asc" ? z.sSortAscending
														: z.sSortDescending))
					} else
						b
								.setAttribute(
					...
					function(e) {
						if (a.aoColumns[c].bSortable !== false) {
							...
							if (a.oFeatures.bProcessing) {
								...
								setTimeout(function() {
									f();
									a.oFeatures.bServerSide || O(a, false)
								}, 0)
							} else
								f();
		...
		function M(a, b, c) {
			...
			if (b === 0)
				...
				ha.console && console.log && console.log(a)
		}
		function q(a, b, c, d) {
			if (d === p)
				d = c;
		...
		function gb(a) {
			return function() {
				var b = [ A(this[m.ext.iApiIndex]) ]
						.concat(Array.prototype.slice.call(arguments));
				return m.ext.oApi[a].apply(this, b)
			}
		}
		var hb = ha.JSON ? JSON.stringify : function(a) {
			var b = typeof a;
			if (b !== "object" || a === null) {
				if (b === "string")
					a = '"' + a + '"';
		...
		this.$ = function(a, b) {
			var c, d = [], e = A(this[m.ext.iApiIndex]);
			b || (b = {});
			b = i.extend({}, {
				filter : "none",
				order : "current",
			...
			if (b.page == "current") {
				...
				M(e, 1, "Unknown selection options");
			e = i(d);
			d = e.filter(a);
			a = e.find(a);
		...
		this.fnClose = function(a) {
			for ( var b = A(this[m.ext.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++)
		...
		this.fnDeleteRow = function(a, b, c) {
			var d = A(this[m.ext.iApiIndex]), e, f;
		...
		this.fnDestroy = function(a) {
			var b = A(this[m.ext.iApiIndex]), c = b.nTableWrapper.parentNode, d = b.nTBody, e, f;
			a = a === p ? false : true;
			b.bDestroying = true;
			e = 0;
		...
		this.fnGetPosition = function(a) {
			var b = A(this[m.ext.iApiIndex]), c = a.nodeName.toUpperCase();
			if (c == "TR")
				return N(b, a);
			else if (c == "TD" || c == "TH") {
				c = N(b, a.parentNode);
		...
		this.fnOpen = function(a, b, c) {
			var d = A(this[m.ext.iApiIndex]), e = ca(d);
			if (i.inArray(a, e) !== -1) {
				this.fnClose(a);
		...
		this.fnSetColumnVis = function(a, b, c) {
			var d = A(this[m.ext.iApiIndex]), e, f, g = d.aoColumns, j = d.aoData, l, k;
			if (g[a].bVisible != b) {
				if (b) {
					for (e = f = 0; e < a; e++)
						g[e].bVisible && f++;
				...
				for (f = d.aoOpenRows.length; e < f; e++)
					d.aoOpenRows[e].nTr.colSpan = C(d);
				if (c === p || c) {
					o(d);
					H(d)
				}
		...
		this.fnSortListener = function(a, b, c) {
			ua(A(this[m.ext.iApiIndex]), a, b, c)
		};
		this.fnUpdate = function(a, b, c, d, e) {
			var f = A(this[m.ext.iApiIndex]);
			...
			f.asDataSearch[c] = za(f, ka(f, b, "filter"));
			if (e === p || e)
				o(f);
			if (d === p || d)
				na(f);
	...
	m.models.ext = {
		...
		fnVersionCheck : function(h) {
			...
			h = h.split(".");
			for ( var o = "", w = "", x = 0, C = h.length; x < C; x++) {
				o += n(r[x], 3);
				w += n(h[x], 3)
			}
					...
					m.ext.oPagination,
					{
						two_button : {
							fnInit : function(h, n, r) {
								var o = h.oLanguage.oPaginate, w = function(C) {
									h.oApi._fnPageChange(h, C.data.action)
											&& r(h)
								};
								o = !h.bJUI ? '<a class="'
								...
								if (h.aanFeatures.p) {
									var r = m.ext.oPagination.iFullNumbersShowPages, o = Math
											...
											.ceil(h._iDisplayStart
													/ h._iDisplayLength) + 1, C = "", D, G = h.oClasses, F, R = h.aanFeatures.p, P = function(
											ja) {
