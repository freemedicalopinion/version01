									...
									<div class="col-md-9 col-sm-8">
										...
										<div class="table-responsive">
											...
											<table class="table table-mailbox">
												...
												<c:forEach items="${hospitalServices}" var="spe">
													<tr>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Add Services
					</h4>
				</div>
				<form method="post" action="addServices">
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Select Multiple</label> <select multiple
								class="form-control" name="servicesToAdd[]"
								id="specilitiesToAdd">
								<c:forEach items="${allServices}" var="spe">
					...
					<div class="modal-footer clearfix">
						...
						<button type="submit" class="btn btn-primary pull-left">
							<i class="fa fa-envelope"></i> Add Service
						</button>
					</div>
				</form>
			</div>
