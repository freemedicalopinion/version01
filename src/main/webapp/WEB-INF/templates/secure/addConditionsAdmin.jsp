...
<body class="skin-blue">
								...
								<div class="row">
									<div class="col-md-3 col-sm-4">
										...
										<div class="box-header">
											...
											<h3 class="box-title">Create Condition</h3>
										</div>
										<!-- compose message btn -->
	...
	<!-- ./wrapper -->
	<form id="deleteSpecilityForm" action="deleteCondition" method="post">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Edit Condition
					</h4>
				</div>
				<form:form method="post" modelAttribute="specility"
					action="createConditionPage" id="edit-specility-form">
					<div class="modal-body">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Condition Name:</span> <input
									name="conditionName" id="specility-name" type="text" class="form-control"
					...
					<div class="modal-footer clearfix">
						...
						<button type="submit" class="btn btn-primary pull-left">
							<i class="fa fa-envelope"></i> Edit Condition
						</button>
					</div>
				</form:form>
			</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Create Condition
					</h4>
				</div>
				<form:form method="post" modelAttribute="specility"
					action="createConditionPage">
					<div class="modal-body">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Condition Name:</span> <input
									name="conditionName" type="text" class="form-control"
					...
					<div class="modal-footer clearfix">
						...
						<button type="submit" class="btn btn-primary pull-left">
							<i class="fa fa-envelope"></i> Create Condition
						</button>
					</div>
				</form:form>
			</div>
