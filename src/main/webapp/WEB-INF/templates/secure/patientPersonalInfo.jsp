...
<body class="skin-blue">
											...
											<div class="col-md-8">
												<div class="box box-primary">
													<div class="box-header">
														...
														<h3 class="box-title">
															<a href="#" style="margin-left: 25px;">${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.fname}
																${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.lname}</a>
														</h3>
													...
													<div class="box-body">
														...
														${dbsmoPatient.gender }<br> ${dbsmoPatient.city }<br> ${dbsmoPatient.mobile }<br>
													</div>
	...
	<div class="modal fade" id="edit-profile" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form:form method="post" modelAttribute="smoPatient"
					action="addPatientPersonalInfo">
					<div class="modal-body">
						<div class="form-group">
						...
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">City:</span> <input name="city"
									...
									placeholder="city" value=" ${dbsmoPatient.city }">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Mobile:</span> <input name="mobile"
									type="text" class="form-control"
									placeholder="mobile" ID="password" value=" ${dbsmoPatient.mobile }">
							</div>
						</div>
	...
	<script>
		...
		$('#gender').val("${dbsmoPatient.gender}");
		if($('#gender').val()== null){
			$('#gender').val("Male");
		}
