...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					Blogs Approval <small>Control panel</small>
				</h1>
				<ol class="breadcrumb">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-md-3 col-sm-4">
										...
										<form method="get" action="editBlogPage" id="blog-edit-form">
										...
										<div style="margin-top: 15px;">
											<ul class="nav nav-pills nav-stacked">
												...
												<li class="active"><a
													href="blogApprovalPage?filter=all"><i
														class="fa fa-inbox"></i> Pending Approval (${pendingApprovalSize})</a></li>
												<li><a href="blogApprovalPage?filter=rejected"><i
														class="fa fa-thumbs-down"></i> Rejected (${rejectedSize })</a></li>
												<li><a href="blogApprovalPage?filter=published"><i
															...
															<c:choose>
																<c:when test="${blog.blogTitle== ''}">
																	<td class="subject"><a href="#"
																		onclick="editBlog('${blog.id}');">(no title)</a></td>
																</c:when>
																...
																<c:otherwise>
																	<td class="subject blog-title"><a href="#"
																		onclick="editBlog('${blog.id}');">${blog.blogTitle}</a></td>
																</c:otherwise>
															</c:choose>
		...
		<!-- /.right-side -->
		<form id="approve-blog-form" action="publishBlog" method="post">
		
			<input type="hidden" name="id" class="blogaction" />
		</form>
		<form id="reject-blog-form" action="rejectBlog" method="post">
			<input type="hidden" name="id" class="blogaction" />
		</form>
	...
	<script type="text/javascript">
		...
		function editBlog(id) {
			$('#blog-id').val(id);
			document.getElementById('blog-edit-form').submit();
		}
		...
		$(document.body).on(
				...
				function() {
					...
					if ($(this).hasClass('checked')) {
						...
						if (blogStatus == 'pendingApproval') {
							removeDisabledClass('reject');
							removeDisabledClass('preview');
							removeDisabledClass('approve');
		...
		$("#approve").click(function() {
			$('#approve-blog-form').submit();
		});
		$("#reject").click(function() {
			$('#reject-blog-form').submit();
		});
	</script>
