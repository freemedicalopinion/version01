								...
								<div class="row">
									<div class="col-md-3 col-sm-4">
										...
										<div class="box-header">
											...
											<h3 class="box-title">Manage Condition</h3>
										</div>
										<!-- compose message btn -->
									...
									<div class="col-md-9 col-sm-8">
										...
										<div class="table-responsive">
											...
											<table class="table table-mailbox">
												...
												<c:forEach items="${docConditions}" var="spe">
													<tr>
														<td>${spe.conditionName }</td>
													...
													<form action="deleteCondition" method="post"
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Add Condition
					</h4>
				</div>
				<form method="post" action="addConditions">
					<div class="modal-body">
						<!-- Select multiple-->
						<div class="form-group">
							<label>Select Multiple</label> <select multiple
								class="form-control" name="conditionsToAdd[]"
								id="specilitiesToAdd">
								<c:forEach items="${allConditions}" var="spe">
									<option value="${spe.id}">${spe.conditionName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
