...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					Create a new Blog <small>Share knowledge</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div class="box box-solid">
							<div class="box-body" style="padding: 0px;">
										...
										<div class="nav-tabs-custom">
											<ul class="nav nav-tabs" id="ul-tabs">
												<li class="active " id="category-tab"><a
													href="#category" data-toggle="tab">Choose Category</a></li>
												<li id="title-tab"><a href="#title" data-toggle="tab">Add
														Title</a></li>
												<li id="content-tab"><a href="#content"
													data-toggle="tab">Add Content</a></li>
												<li id="images-tab"><a href="#images" data-toggle="tab">Add
														Images</a></li>
											</ul>
													...
													<form:form method="post" modelAttribute="blogObj"
														...
														<div class="modal-body">
															...
															<div class="form-group">
																<textarea name="summary" id="summary-text-input"
																	...
																	placeholder="Summary" style="height: 120px;"></textarea>
														...
														<div class="modal-footer clearfix"
															...
															<button type="button"
																...
																<i class="fa fa-envelope"></i> Add Title
															</button>
														</div>
													</form:form>
												</div>
													...
													<form:form method="post" modelAttribute="blogObj"
														...
														<div class="modal-body">
															<div class="form-group">
																<textarea name="content" id="content-text-input"
																	...
																	name="content" style="height: 120px;"></textarea>
															</div>
														...
														<div class="modal-footer clearfix"
															...
															<button type="button"
																...
																<i class="fa fa-envelope"></i> Add Content
															</button>
														</div>
													</form:form>
												</div>
													...
													<form:form method="post" modelAttribute="images"
														...
														<div class="modal-body">
															<div class="form-group"
																...
																<div style="float: left; width: 50%;">
																	<img src="#" style="width: 150px;" id="bigImagePreview">
																</div>
															</div>
														...
														<div class="modal-footer clearfix"
															...
															<button type="button" class="btn btn-primary pull-left"
																...
																<i class="fa fa-envelope"></i> Add Picture And Draft
															</button>
															<button type="button" class="btn btn-primary pull-left"
																id="submit-images" onclick="ispublishContent(1);">
																<i class="fa fa-envelope"></i> Add Picture And Publish
															</button>
								...
								<div class="row">
									...
									<div class="col-md-3" id="category-summary"
										...
										<div class="box box-primary">
											...
											<div class="box-body">
												<dl>
													<dt>Category</dt>
													<dd id="category-text"></dd>
													<dt>Sub-Category/s</dt>
													<dd id="sub-category-text"></dd>
												</dl>
											</div>
											<!-- /.box-body -->
										</div>
									...
									<div class="col-md-3" id="title-summary" style="display: none">
										<div class="box box-primary">
											<div class="box-header">
											...
											<div class="box-body">
												<dl>
													...
													<dd id="title-text"></dd>
													<dt>Sub-Title</dt>
													<dd id="sub-title-text"></dd>
													<dt>Summary</dt>
													<dd id="summary-text"></dd>
												</dl>
											</div>
											<!-- /.box-body -->
										</div>
	...
	<script>
		...
		function deleteKeyWord(event) {
			var keyword= $(event).closest('div').text().replace('×','').trim();	
			if(keyword == ""){
				return;
			}
			$.ajax({
