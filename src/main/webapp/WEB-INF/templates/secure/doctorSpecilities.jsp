								...
								<div class="row">
									<div class="col-md-3 col-sm-4">
										...
										<div class="box-header">
											...
											<h3 class="box-title">Manage Specility</h3>
										</div>
										<!-- compose message btn -->
									...
									<div class="col-md-9 col-sm-8">
										...
										<div class="table-responsive">
											...
											<table class="table table-mailbox">
												...
												<c:forEach items="${docSpecilities}" var="spe">
													<tr>
														<td>${spe.specilityName }</td>
													...
													<form action="deleteSpecilities" method="post"
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Add Specilities
					</h4>
				</div>
				<form method="post" action="addSpecilites">
					<div class="modal-body">
						<!-- Select multiple-->
						<div class="form-group">
							<label>Select Multiple</label> <select multiple
								class="form-control" name="specilitiesToAdd[]"
								id="specilitiesToAdd">
								<c:forEach items="${allSpecilities}" var="spe">
									<option value="${spe.id}">${spe.specilityName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					<div class="modal-footer clearfix">
						...
						<button type="submit" class="btn btn-primary pull-left">
							<i class="fa fa-envelope"></i> Add Specilities
						</button>
					</div>
				</form>
			</div>
