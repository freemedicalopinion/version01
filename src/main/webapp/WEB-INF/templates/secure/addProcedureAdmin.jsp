...
<body class="skin-blue">
								...
								<div class="row">
									<div class="col-md-3 col-sm-4">
										...
										<div class="box-header">
											...
											<h3 class="box-title">Create Procedures</h3>
										</div>
										<!-- compose message btn -->
	...
	<!-- ./wrapper -->
	<form id="deleteSpecilityForm" action="deleteProcedure" method="post">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Edit Procedure
					</h4>
				</div>
				<form:form method="post" modelAttribute="specility"
					action="createProceduresPage" id="edit-specility-form">
					<div class="modal-body">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Procedure Name:</span> <input
									name="procedureName" id="specility-name" type="text" class="form-control"
					...
					<div class="modal-footer clearfix">
						...
						<button type="submit" class="btn btn-primary pull-left">
							<i class="fa fa-envelope"></i> Edit Procedure
						</button>
					</div>
				</form:form>
			</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">
						<i class="fa fa-envelope-o"></i> Create Procedure
					</h4>
				</div>
				<form:form method="post" modelAttribute="specility"
					action="createProceduresPage">
					<div class="modal-body">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Procedure Name:</span> <input
									name="procedureName" type="text" class="form-control"
					...
					<div class="modal-footer clearfix">
						...
						<button type="submit" class="btn btn-primary pull-left">
							<i class="fa fa-envelope"></i> Create Procedure
						</button>
					</div>
				</form:form>
			</div>
