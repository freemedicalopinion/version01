					...
					<form method="post" action="changepassword">
						<div class="row">
							<input type="password" name="newPassword" id="newPassword"
								placeholder="New Password" required> <i
								class="fa fa-envelope"></i>
						</div>
						<div class="row">
							<input type="password" name="confirmnewPassword"
								id="confirmnewPassword" placeholder="Conform New Password"
								required> <i class="fa fa-envelope"></i>
						</div>
						<div class="row">
							<input type="password" name="tmpPassword" id="tmpPassword"
								placeholder="Tmp Password" required> <i
								class="fa fa-envelope"></i>
						</div>
						<input type="hidden" value="${changepasswordtoken}"
