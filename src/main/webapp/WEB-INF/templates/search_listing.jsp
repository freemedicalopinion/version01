		...
		<div class="page">
			...
			<header class="page-header main-page">
				...
				<section id="logo" class="logo">
					<div>
						<a href="/smo"><img src="img/blue/logo.png" width="190" height="50" alt="Clinico"></a>
					</div>
				</section>
				<!--/ logo -->
				...
				<nav class="main-nav">
					<ul>
						<li>
							<a href="/smo"><i class="fa fa-plus"></i>Home</a>
							<ul>
								<li>
									<a href="/smo">Medical Style</a>
									<ul>
										<li class="text">
											<h2>Main Campus</h2>
											<hr>
						...
						<li>
							<a href="news-default.html" class="active"><i class="fa fa-plus"></i>News</a>
							<ul>
								...
								<li><a href="news-blog-post.html" class="active">Blog post</a></li>
							</ul>
						</li>
						<li class="right">
							<a href="/smo"><i class="fa fa-plus"></i>Features</a>
							<ul>
				...
				<nav id="mobile-main-nav" class="mobile-main-nav">
					...
					<ul>
						<li>
							<i></i><a href="/smo" class="active">Home</a>
							<ul>
								<li>
				...
				<div class="grid-row">
					<div class="grid-col grid-col-9">
						...
						<section class="widget comments">	
							...
							<div class="widget-title">Search Related Your Query : Cervical Pain</div>
							<ul>
								<li>
					...
					<div class="grid-col grid-col-3">
						...
						<section class="widget widget-comments">
							<div class="widget-title">Related Doctors</div>
							<div class="owl-carousel owl-theme" id="comments-carousel" style="opacity: 1; display: block;">
								<div class="owl-wrapper-outer autoHeight" style="height: 490px;"><div class="owl-wrapper" style="width: 1620px; left: 0px; display: block;"><div class="owl-item" style="width: 270px;"><div class="item">
									<ul>
										<li>
											<img alt="" src="pic/doctor-1.jpg">
